...
export const markets: Market[] = [
  {
    ...
    body: [
      "Florida is where the firm started and where the largest share of the portfolio sits. Paradise Ventures has operated from Pinellas County since 1988 — founded in Safety Harbor, now based in downtown St. Petersburg — through multiple growth cycles, two significant downturns, and the transformation of nearly every major trade area in the state.",
